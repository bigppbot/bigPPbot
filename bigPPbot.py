...
async def on_message(message):
    ...
    if message.content.upper() == 'YES!' or message.content.startswith('YES!'):
    ...
    if message.content.upper() == 'MUDA!' or message.content.startswith('MUDA'):
    ...
    if message.content.lower() == '~beer':
        await message.channel.send("", file=discord.File('gifs/beer.gif', 'beer.gif'));return

    if message.content.lower() == '~energy' or message.content.lower() == '~nrg':
